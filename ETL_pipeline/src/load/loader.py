...
if __name__ =="__main__":  
    query_paths_structure = [
        "./Data_Warehouse_Arhitecture/src/schemas/create_gold_schema.sql",
        "./Data_Warehouse_Arhitecture/src/gold/creating/creating_gold_layer_structure_and_data.sql",
        "./Data_Warehouse_Arhitecture/src/gold/creating/creating_views_for_reports.sql"
        ]
